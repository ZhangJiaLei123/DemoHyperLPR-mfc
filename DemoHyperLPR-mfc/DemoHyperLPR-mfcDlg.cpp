...
BEGIN_DHTML_EVENT_MAP(CDemoHyperLPRmfcDlg)
	DHTML_EVENT_ONCLICK(_T("ButtonOK"), OnButtonOK)
	DHTML_EVENT_ONCLICK(_T("ButtonCancel"), OnButtonCancel)
END_DHTML_EVENT_MAP()


CDemoHyperLPRmfcDlg::CDemoHyperLPRmfcDlg(CWnd* pParent /*=NULL*/)
	: CDHtmlDialog(IDD_DEMOHYPERLPRMFC_DIALOG, IDR_HTML_DEMOHYPERLPRMFC_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CDemoHyperLPRmfcDlg, CDHtmlDialog)
	ON_WM_SYSCOMMAND()
END_MESSAGE_MAP()
...
HRESULT CDemoHyperLPRmfcDlg::OnButtonOK(IHTMLElement* /*pElement*/)
{
	OnOK();
	return S_OK;
}

HRESULT CDemoHyperLPRmfcDlg::OnButtonCancel(IHTMLElement* /*pElement*/)
{
	OnCancel();
	return S_OK;
}
